...
window.MONOGRAPH_SCHEMA = [
  {
    ...
    hint: 'ประเด็นเร่งด่วน/คำเตือนระดับสูงที่ผู้ใช้ควรเห็นก่อน เช่น การเรียกคืนผลิตภัณฑ์ การปลอมปน',
    children: [
      {
        id: 'boxedWarning', en: 'US Boxed Warning', th: 'คำเตือนร้ายแรง (Boxed Warning)',
        hint: 'คำเตือนร้ายแรงที่สุด (ถ้ามี) — สำหรับผลิตภัณฑ์เสริมอาหารมักไม่มี แต่ใช้บันทึกคำเตือนระดับร้ายแรงจากหน่วยงานกำกับดูแลได้',
      },
    ],
  },
  {
    id: 'brandNames', en: 'Brand Names', th: 'ชื่อการค้า',
    children: [
      { id: 'brandUS', en: 'US', th: 'สหรัฐอเมริกา', hint: 'ตัวอย่างชื่อการค้าที่จำหน่ายในสหรัฐอเมริกา' },
      { id: 'brandCanada', en: 'Canada', th: 'แคนาดา', hint: 'ตัวอย่างชื่อการค้าที่จำหน่ายในแคนาดา' },
    ],
  },
  {
