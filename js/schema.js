...
// หมายเหตุ: การแจ้งเตือน (ALERTS) แสดงเป็นแบนเนอร์สีแดงด้านบนของหน้าโมโนกราฟ
// โดยดึงจาก field `alerts` ของแต่ละรายการโดยตรง (ดู app.js) จึงไม่มีหัวข้อ ALERTS ใน outline นี้
